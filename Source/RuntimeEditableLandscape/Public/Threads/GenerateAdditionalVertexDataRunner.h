 ...
 */
class RUNTIMEEDITABLELANDSCAPE_API FGenerateAdditionalVertexDataRunner : public IQueuedWork
{
	friend class URuntimeLandscapeRebuildManager;

public:
	FGenerateAdditionalVertexDataRunner(URuntimeLandscapeRebuildManager* RebuildManager);
	~FGenerateAdditionalVertexDataRunner();
...
private:
	...
	void GenerateGrassTransformsAtVertex(const ULandscapeGrassType* SelectedGrass, const int32 VertexIndex,
	                                     float Weight);
